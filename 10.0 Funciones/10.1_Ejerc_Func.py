...
#Ejercicio#1.1
# Solicitar números al usuario hasta que ingrese el cero.
# Por cada uno, mostrar la suma de sus dígitos. Al finalizar,
# mostrar la sumatoria de todos los números ingresados y la
# suma de sus dígitos.
sumatoria=0
num=int(input("Número a procesar: "))
while num!=0:
...
# la cantidad de veces que aparece en el número
# (frecuencia).
# Al finalizar el programa, mostrar el factorial 
