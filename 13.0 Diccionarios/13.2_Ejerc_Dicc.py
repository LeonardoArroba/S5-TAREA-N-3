# Ejercicio#1
# Crear un programa para gestionar datos de los socios
# de un club, permitiendo:
# -Cargar información de los socios en un diccionario
# para acceder por número de socio. Los datos a almacenar
# son: número, nombre y apellido, fecha de ingreso (ddmmaaaa),
# cuota al día (s/n). El programa debe iniciar con los datos
...
# -Solicitar al usuario el número de un socio y registrar que ha
# pagado todas las cuotas adeudadas.
# -Modificar la fecha de ingreso de todos los socios ingresados el
# 13/03/2018, para indicar que en realidad ingresaron el 14/03/2018.
...
socios_activos={1:["Amanda Núñez","17032009",True], 2:["Bárbara Molina","17032009",True],
